...
一款玻璃拟态（Glassmorphism）风格的 Hexo 主题

<p>极光渐变背景上的磨砂玻璃卡片，悬浮胶囊式 Dock 导航，以及一整套漂浮玻璃碎片的 3D 视觉签名。</p>
...
**Tessera** 是一款现代化的 Hexo 主题，设计语言为**玻璃拟态**：半透明磨砂卡片悬浮于极光渐变背景之上，顶部是一条圆角胶囊式的 **Dock 导航栏**。它从 [Butterfly](https://github.com/jerryc127/hexo-theme-butterfly) 重构而来，保留了丰富的功能生态，并在视觉与交互上做了彻底的重新设计，以 **AGPL-3.0** 重新授权。

## 🎨 主题特色

### 视觉与交互
- **玻璃拟态设计** — 全站统一的磨砂玻璃卡片，悬停时呈现液态高光
- **Dock 胶囊导航** — 悬浮圆角导航栏，菜单/搜索为药丸样式
